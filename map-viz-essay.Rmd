...
map_1880 <- st_read("D:/clio-II/mapping-viz-essay/us_county_2/US_county_1880.shp", stringsAsFactors = FALSE)
...
```{r, message=FALSE, echo=FALSE}
map_1890 <- st_read("D:/clio-II/mapping-viz-essay/US_county_1/US_county_1890.shp", stringsAsFactors = FALSE)
...
```{r, message=FALSE, echo=FALSE}
map_1960 <- st_read("D:/clio-II/mapping-viz-essay/US_county_1960_conflated/US_county_1960_conflated.shp", stringsAsFactors = FALSE)
...
census_pal <- colorBin("OrRd",
                       domain = map_1890_4326_data$Asia,
                       bins = 7, na.color = "#808080")

leaflet(map_1960_4326_data) %>% 
  addTiles() %>% 
  addPolygons(fillColor = ~census_pal(Asia),
              fillOpacity = 1,
              color = "black",
              opacity = 1,
              weight = 1) %>% 
  addLegend("bottomright", pal = census_pal,
            values = ~Asia, opacity = 1,
            title = "Immigrant Population Born in Asia")
